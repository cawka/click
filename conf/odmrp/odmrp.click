...
// Odmrp member and routing table
odamemtb :: OdmrpMemberTable(1, 230.10.10.10);
odaroutb :: OdmrpRoutingTable();

//odaagent :: OdmrpAgent(odamemtb, odaroutb, 131.179.136.46);
odaagent :: OdmrpAgent(odamemtb, odaroutb, 131.179.25.11);
...
etherclaasify :: Classifier(6/00022D74F980,-);
...
checkd[1] -> Discard;
checkd[0] -> dt::DecIPTTL() -> odaagent;
dt[1] -> Discard;

odaagent[0] -> Discard;
odaagent[1]	-> EtherEncap(0x800,00:02:2D:3C:21:FA, ff:ff:ff:ff:ff:ff)
						-> rt;
odaagent[2] -> UDPIPEncap(131.179.25.11, 999, 224.0.0.13, 998)

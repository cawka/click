...
#define CHECK_DUPLICATED+PACKETS_HH 
...
and IP sequence number to check duplicated mulitcast packets. For eodmrp control packets,
it uses sender and multicast IP address and eodmrp sequence number.
...
=a
EodmrpAgent, EodmrpMemberTable, EodmrpRoutingTable
*/

...
struct dtcast_fwd_tuple_t : public age_tuple_t<ROUTE_REPLY_MAXAGE>
{
	...
	dtcast_fwd_tuple_t( mcast_t mcast_id, node_t src_id, bool fw_flag )
			: _mcast_id(mcast_id),_src_id(src_id),_fw_flag(fw_flag)
	{ }
	
	bool operator==( const dtcast_fwd_tuple_t &tuple )
	{
